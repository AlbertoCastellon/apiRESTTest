...
/**
 * 
 * Storage for the different users and passwords. Also validation of those credentials.
 *
 */
@RequestScoped
public class AuthenticationIdentityStore implements IdentityStore {
    ...
    public void init() {
        ...
        callerToPassword.put("admin", "passwordAdmin");
        callerToPassword.put("user", "password");
    }
